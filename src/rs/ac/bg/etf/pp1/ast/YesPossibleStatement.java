...
public class YesPossibleStatement extends PossibleStatement {

    private ElseStatement ElseStatement;
    private Statement Statement;

    public YesPossibleStatement (ElseStatement ElseStatement, Statement Statement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("YesPossibleStatement(\n");
