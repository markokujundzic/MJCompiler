...
public class DesignatorAdditionActPars extends DesignatorAddition {

    private DesignatorActPars DesignatorActPars;

    public DesignatorAdditionActPars (DesignatorActPars DesignatorActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorAdditionActPars(\n");
