...
public class TermFiniteExpr extends FiniteExpr {

    private FiniteTerm FiniteTerm;
    private OptionalTermList OptionalTermList;

    public TermFiniteExpr (FiniteTerm FiniteTerm, OptionalTermList OptionalTermList) {
