...
public class YesDeclarationList extends DeclarationList {

    private DeclarationList DeclarationList;
    private Declaration Declaration;

    public YesDeclarationList (DeclarationList DeclarationList, Declaration Declaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("YesDeclarationList(\n");
