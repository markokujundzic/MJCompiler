...
public class YesMethodStatements extends MethodStatements {

    private MethodStatements MethodStatements;
    private Statement Statement;

    public YesMethodStatements (MethodStatements MethodStatements, Statement Statement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("YesMethodStatements(\n");
